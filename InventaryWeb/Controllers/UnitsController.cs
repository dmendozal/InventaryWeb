...
namespace InventaryWeb.Controllers
{
    public class UnitsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description,Abbreviation")] Unit unit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description,Abbreviation")] Unit unit)
        {
            if (ModelState.IsValid)
            {
