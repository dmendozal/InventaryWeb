...
namespace InventaryWeb.Controllers
{
    public class ProvidersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Ci,Name,Telephone,Address")] Provider provider)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Ci,Name,Telephone,Address")] Provider provider)
        {
            if (ModelState.IsValid)
            {
        ...
        public int ProvidersIndex()
        {
            return db.Provider.ToList().Count();
        }
